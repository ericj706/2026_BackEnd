...
public class Practice1 { // class s
    ...
    지시: int 타입의 변수 age를 선언하고, 자신의 임의의 나이를 리터럴로 대입한 뒤, 변수 age를 출력해 보세요.*/
        // JAVA: 타입 변수명 = 10 [vs] JS: let 변수명 = 10
        int age =40;
    ...
    좌우명: String 타입의 motto*/
        // 3. 변수의 초기화 : 변수 선언시 처음에 자료 대입
        String name= "유재석"; int age2 = 40; double height = 173.5; String motto = "~살자";
        
    /* 문제 4: 출력 함수와 문자열 연결
    지시: 문제 3에서 만든 변수들을 System.out.println() 함수와 + 연산자를 사용하여 아래와 같이 한 문장으로 출력하세요.
    예시: 제 이름은 홍길동, 나이는 25세, 키는 175.5cm 입니다.*/
        // 4. +더하기 연산자와 연결연산자, "문자열"+변수명+"문자열"
        System.out.println("제이름은 "+name+", 나이는 "+age+"세, 키는 "+height+"cm, 모토는 "+motto+"입니다");
    ...
    */
        ...
        System.out.println("이름을 입력하세요: "); String 이름 = scan.next();
        System.out.println("나이를 입력하세요: "); int 나이 = scan.nextByte();
    ...
    */
    ...
    출력 예시:
    입력하신 성별은 '남' 입니다.
    10. nextChar() 제공x. next.charAt(인덱스) : 해당 인덱스의 문자1개 추출함수, *문자열은 배열이다*
    */
    ...
    프로그래머 여부: true
    */
        System.out.print("이름: "); String 이름1 = scan.next();
        System.out.print("나이: "); int 나이1 = scan.nextInt();
        System.out.print("키: ");   float 키 = scan.nextFloat();
        System.out.print("프로그래머입니까? (true/false): "); String 진위 = scan.next();
