...
출력 예시:
비율: 25.0% 
        System.out.print("첫 번째 실수: "); double 수1 = scan.nextDouble();
        System.out.print("두 번째 실수: "); double 수2 = scan.nextDouble();
        double 비율 = (수1 / 수2) *100;
        System.out.printf("비율: "+비율+ "\n");
/*[문제 4] Scanner를 이용해 정수 하나를 입력받아, 그 수가 홀수이면 true, 짝수이면 false를 출력하시오.
입력 예시:
정수를 입력하세요: 17
출력 예시:
결과: true 
        System.out.print("정수를 입력하세요: "); int 정수1 = scan.nextInt();
        int 결과1 = 정수1 % 2 ;
        if (결과1 != 0) {
            System.out.print("true");
        }
        System.out.println(정수1 % 2 != 0);
...
출력 예시:
결과: true 
        6. JAVA/C == 문자열 비교 불가능, JS/PY == 문자열 비교 가능
...
결과: true 
        ...
        System.out.println( 정수3 % 7 ==0 && 정수3 % 2!=0);
...
출력 예시:
결과: 합격 
        System.out.print("1차 점수: "); int num1 = scan.nextInt();
        System.out.print("2차 점수: "); int num2 = scan.nextInt();
        System.out.println(sum1+sum2 >= 150? "합격" : "불합격");
...
결과: 관리자 
        ...
        System.out.println(id.equals("user1") || email.equals("admin@test.com") ? "관리자" : "일반 사용자");
...
이벤트 대상입니다. */
        ...
        System.out.println(나이2 >= 20 && 나이2 <= 29 ?  "이벤트 대상입니다." : "이벤트 대상이 아닙니다.");
